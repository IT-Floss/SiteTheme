    ...
    var Dictionary = (function () {
        function Dictionary(options) {
            ...
            this.data = {
                ...
                "entry-not-found": "No se encontró el ítem.",
                "input-placeholder": "Escribí tu respuesta acá ...",
                "group-placeholder": "Escribí para filtrar ...",
                "input-placeholder-error": "Este campo es incorrecto ...",
                "input-placeholder-required": "Este dato es obligatorio para continuar ...",
                "input-placeholder-file-error": "Ups, error al subir archivo ...",
                "input-placeholder-file-size-error": "El archivo es demasiado grande ...",
                "input-no-filter": "No se encontraron resultados para <strong>{input-value}</strong>",
                "user-reponse-and": " y ",
                "user-reponse-missing": "Input vacío ...",
                "user-reponse-missing-group": "No seleccionaste nada ...",
            ...
            this.robotData = {
                ...
                "input": "Escribí algo.",
                "text": "Escribí algo.",
                "checkbox": "Seleccioná todos los que quieras.",
                "name": "Cómo es tu nombre?",
                "email": "Necesito tu dirección de email.",
                "password": "Por favor necesito tu password",
                "tel": "Cuál es tu número de teléfono?",
                "radio": "Necesito que selecciones alguna de estas opciones.",
                "select": "Elegí alguna de estas.",
